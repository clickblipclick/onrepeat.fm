...
describe('backfill', () => {
  ...
  it('links and enqueues jams that have no track_id; skips already-linked', async () => {
    await db.insertInto('jams').values([
      { uri: 'at://did:plc:a/fm.onrepeat.jam/1', cid: 'c1', author_did: 'did:plc:a', source_url: 'https://open.spotify.com/track/1', source_provider: 'spotify', raw_title: 'A', raw_artist: 'B', created_at: '2026-05-30T00:00:00.000Z' },
      { uri: 'at://did:plc:a/fm.onrepeat.jam/2', cid: 'c2', author_did: 'did:plc:a', source_url: 'https://open.spotify.com/track/2', source_provider: 'spotify', raw_title: 'C', raw_artist: 'D', created_at: '2026-05-30T00:00:00.000Z', track_id: 'isrc:ALREADY' },
    ]).execute()
